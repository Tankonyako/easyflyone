...
@section('content')
    ...
    <div class="e-home-news mt-3 e-sh-1 e-round">
        @include('includes.news', ['limit' => 3, 'showmore' => true, 'horizontal' => false])
    </div>
    <div class="e-discord-info e-sh-1 p-2 mt-3">
        <div class="row">
            <div class="col-md-4 d-flex e-discord-logo-box">
                <span class="cib-discord text-white text-right m-auto"></span>
            </div>
            <div class="col-md-6 text-light mt-5 mb-5 border-left">
